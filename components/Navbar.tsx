                                    ...
                                    {isMenuOpen && (
                                        <div>
                                            <nav className="fixed text-white top-0 right-0 left-0 bottom-0 lg:bottom-auto bg-[#01051e]  ">
                                                ...
                                                <ul className=" lg:hidden w-full gap-4 flex flex-col items-center justify-center h-full ">
                                                    {navigation.map((item) => (
                                                        <li key={item.name}>
                                                            <a
                                                                href={item.lien}
                            ...
                            <Dialog open={open} onOpenChange={setOpen}>
                                <DialogContent className="text-white overflow-auto max-h-[600px] sm:max-w-[425px]">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Merci de remplir le formulaire notre
                                            équipe support vous contactera
                                        </DialogDescription>
                                    </DialogHeader>
